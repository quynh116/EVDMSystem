...
namespace EVMDealerSystem.BusinessLogic.Services.Interfaces
{
    public interface IVehicleService
    {
        ...
        Task<Result<VehicleResponse>> GetVehicleByIdAsync(Guid id, Guid? userId);
        ...
        Task<Result<bool>> SetDealerSellingPriceAsync(Guid userId, DealerSellingPriceRequest request);
    }
}
