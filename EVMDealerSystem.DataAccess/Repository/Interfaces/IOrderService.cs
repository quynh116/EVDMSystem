...
// EVMDealerSystem.BusinessLogic.Models.Responses;
...
namespace EVMDealerSystem.DataAccess.Repository.Interfaces
{
    public interface IOrderService
    {
        ...
        //<Result<OrderResponse>> GetOrderByIdAsync(Guid id);
        ...
        //<Result<decimal>> CalculateOrderPriceAsync(Guid vehicleId, Guid? promotionId);
    }
}
